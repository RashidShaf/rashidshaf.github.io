...
const inputClass = 'w-full px-4 py-2.5 bg-admin-bg border border-admin-input-border rounded-lg text-sm text-admin-text focus:outline-none focus:border-admin-accent';
    ...
    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4 }}>
      <div className="space-y-6 max-w-3xl">
        ...
        <div className="bg-admin-card rounded-xl border border-admin-border p-6 shadow-sm">
          <h2 className="text-lg font-bold text-admin-text mb-4">Store Information</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              <label className="block text-sm font-medium text-admin-text mb-1.5">Store Name (English)</label>
            ...
            <div>
              <label className="block text-sm font-medium text-admin-text mb-1.5">Store Name (Arabic)</label>
            ...
            <div>
              <label className="block text-sm font-medium text-admin-text mb-1.5">Email</label>
            ...
            <div>
              <label className="block text-sm font-medium text-admin-text mb-1.5">Phone</label>
            ...
            <div className="md:col-span-2">
              <label className="block text-sm font-medium text-admin-text mb-1.5">Address</label>
        ...
        <div className="bg-admin-card rounded-xl border border-admin-border p-6 shadow-sm">
          <h2 className="text-lg font-bold text-admin-text mb-4">Shipping Configuration</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              <label className="block text-sm font-medium text-admin-text mb-1.5">Free Shipping Threshold (QAR)</label>
            ...
            <div>
              <label className="block text-sm font-medium text-admin-text mb-1.5">Flat Shipping Rate (QAR)</label>
          ...
          <p className="text-xs text-admin-muted mt-3">Orders above the threshold amount will receive free shipping. Below that, the flat rate applies.</p>
        </div>

        {/* Social Media Links */}
        <div className="bg-admin-card rounded-xl border border-admin-border p-6 shadow-sm">
          <h2 className="text-lg font-bold text-admin-text mb-4">Social Media Links</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              <label className="block text-sm font-medium text-admin-text mb-1.5">Instagram</label>
            ...
            <div>
              <label className="block text-sm font-medium text-admin-text mb-1.5">WhatsApp</label>
            ...
            <div>
              <label className="block text-sm font-medium text-admin-text mb-1.5">Facebook</label>
            ...
            <div>
              <label className="block text-sm font-medium text-admin-text mb-1.5">TikTok</label>
            ...
            <div>
              <label className="block text-sm font-medium text-admin-text mb-1.5">X (Twitter)</label>
            ...
            <div>
              <label className="block text-sm font-medium text-admin-text mb-1.5">LinkedIn</label>
            ...
            <div>
              <label className="block text-sm font-medium text-admin-text mb-1.5">Pinterest</label>
        ...
        <div className="flex justify-end">
          <button onClick={handleSave} disabled={saving} className="flex items-center gap-2 px-6 py-2.5 bg-admin-accent text-white rounded-lg text-sm font-semibold hover:bg-blue-600 transition-colors disabled:opacity-50">
            <FiSave size={16} />
