// Production seed - reads parent IDs dynamically from DB
...
const products = {
  ...
  'mystery-thriller': [
    { title: 'Gone Girl', titleAr: 'الفتاة المفقودة', author: 'Gillian Flynn', authorAr: 'جيليان فلين', publisher: 'Crown', price: 50, language: 'en', pages: 432 },
    { title: 'The Silent Patient', titleAr: 'المريضة الصامتة', author: 'Alex Michaelides', authorAr: 'أليكس ميخائيليدس', publisher: 'Celadon', price: 52, language: 'en', pages: 336 },
    { title: 'The Girl on the Train', titleAr: 'فتاة القطار', author: 'Paula Hawkins', authorAr: 'باولا هوكينز', publisher: 'Riverhead', price: 48, language: 'en', pages: 336 },
  ],
  'romance': [
    { title: 'Pride and Prejudice', titleAr: 'كبرياء وتحامل', author: 'Jane Austen', authorAr: 'جين أوستن', publisher: 'Penguin Classics', price: 35, language: 'en', pages: 432 },
    { title: 'The Notebook', titleAr: 'المفكرة', author: 'Nicholas Sparks', authorAr: 'نيكولاس سباركس', publisher: 'Grand Central', price: 42, language: 'en', pages: 227 },
    { title: 'Me Before You', titleAr: 'أنا قبلك', author: 'Jojo Moyes', authorAr: 'جوجو مويز', publisher: 'Penguin', price: 45, language: 'en', pages: 369 },
  ],
  'biography': [
    { title: 'Steve Jobs', titleAr: 'ستيف جوبز', author: 'Walter Isaacson', authorAr: 'والتر إيزاكسون', publisher: 'Simon & Schuster', price: 70, language: 'en', pages: 656 },
    { title: 'Becoming', titleAr: 'أصبحت', author: 'Michelle Obama', authorAr: 'ميشيل أوباما', publisher: 'Crown', price: 65, language: 'en', pages: 448 },
    { title: 'Long Walk to Freedom', titleAr: 'مسيرة طويلة نحو الحرية', author: 'Nelson Mandela', authorAr: 'نيلسون مانديلا', publisher: 'Back Bay', price: 55, language: 'en', pages: 656 },
  ],
  'self-help': [
    { title: 'Atomic Habits', titleAr: 'العادات الذرية', author: 'James Clear', authorAr: 'جيمس كلير', publisher: 'Avery', price: 58, language: 'en', pages: 320 },
    { title: 'The 7 Habits', titleAr: 'العادات السبع', author: 'Stephen Covey', authorAr: 'ستيفن كوفي', publisher: 'Simon & Schuster', price: 50, language: 'en', pages: 381 },
    { title: 'Rich Dad Poor Dad', titleAr: 'الأب الغني والأب الفقير', author: 'Robert Kiyosaki', authorAr: 'روبرت كيوساكي', publisher: 'Plata', price: 45, language: 'en', pages: 336 },
  ],
  'history': [
    { title: 'Sapiens', titleAr: 'العاقل', author: 'Yuval Noah Harari', authorAr: 'يوفال نوح هراري', publisher: 'Harper', price: 62, language: 'en', pages: 443 },
    { title: 'Guns, Germs and Steel', titleAr: 'أسلحة وجراثيم وفولاذ', author: 'Jared Diamond', authorAr: 'جاريد دايموند', publisher: 'Norton', price: 55, language: 'en', pages: 528 },
    { title: 'A Brief History of Time', titleAr: 'تاريخ موجز للزمن', author: 'Stephen Hawking', authorAr: 'ستيفن هوكينج', publisher: 'Bantam', price: 48, language: 'en', pages: 256 },
  ],
  'picture-books': [
    { title: 'The Very Hungry Caterpillar', titleAr: 'اليرقة الجائعة جداً', author: 'Eric Carle', authorAr: 'إريك كارل', publisher: 'Philomel', price: 30, language: 'en', pages: 26, ageRange: '2-5 years' },
    { title: 'Goodnight Moon', titleAr: 'تصبحين على خير يا قمر', author: 'Margaret Wise Brown', authorAr: 'مارغريت وايز براون', publisher: 'Harper', price: 28, language: 'en', pages: 32, ageRange: '1-4 years' },
    { title: 'Where the Wild Things Are', titleAr: 'حيث تعيش الوحوش', author: 'Maurice Sendak', authorAr: 'موريس سنداك', publisher: 'Harper', price: 32, language: 'en', pages: 48, ageRange: '3-7 years' },
  ],
  'early-readers': [
    { title: 'The Cat in the Hat', titleAr: 'القط في القبعة', author: 'Dr. Seuss', authorAr: 'دكتور سوس', publisher: 'Random House', price: 35, language: 'en', pages: 72, ageRange: '4-8 years' },
    { title: "Charlotte's Web", titleAr: 'شبكة شارلوت', author: 'E.B. White', authorAr: 'إي بي وايت', publisher: 'Harper', price: 38, language: 'en', pages: 192, ageRange: '6-10 years' },
    { title: 'Matilda', titleAr: 'ماتيلدا', author: 'Roald Dahl', authorAr: 'رولد دال', publisher: 'Penguin', price: 40, language: 'en', pages: 240, ageRange: '7-11 years' },
  ],
  'quran-tafsir': [
    { title: 'The Holy Quran', titleAr: 'القرآن الكريم', author: 'Various', authorAr: 'متعدد', publisher: 'Dar Al Salam', price: 85, language: 'ar', pages: 604 },
    { title: 'Tafsir Ibn Kathir', titleAr: 'تفسير ابن كثير', author: 'Ibn Kathir', authorAr: 'ابن كثير', publisher: 'Dar Al Salam', price: 120, language: 'ar', pages: 1200 },
    { title: 'The Quran Journal', titleAr: 'يوميات القرآن', author: 'Various', authorAr: 'متعدد', publisher: 'Islamic Press', price: 45, language: 'en', pages: 200 },
  ],
  'hadith-sunnah': [
    { title: 'Riyad as-Salihin', titleAr: 'رياض الصالحين', author: 'Imam Nawawi', authorAr: 'الإمام النووي', publisher: 'Dar Al Salam', price: 75, language: 'ar', pages: 800 },
    { title: 'Sahih Al-Bukhari', titleAr: 'صحيح البخاري', author: 'Imam Bukhari', authorAr: 'الإمام البخاري', publisher: 'Dar Al Salam', price: 150, language: 'ar', pages: 1500 },
    { title: 'The Sealed Nectar', titleAr: 'الرحيق المختوم', author: 'Safiur Rahman', authorAr: 'صفي الرحمن المباركفوري', publisher: 'Dar Al Salam', price: 55, language: 'ar', pages: 580 },
  ],
  'science-math': [
    { title: 'Physics for Students', titleAr: 'الفيزياء للطلاب', author: 'David Halliday', authorAr: 'ديفيد هاليداي', publisher: 'Wiley', price: 95, language: 'en', pages: 720 },
    { title: 'Calculus Made Easy', titleAr: 'التفاضل والتكامل بسهولة', author: 'Silvanus Thompson', authorAr: 'سيلفانوس تومبسون', publisher: 'Dover', price: 40, language: 'en', pages: 336 },
    { title: 'Biology Essentials', titleAr: 'أساسيات الأحياء', author: 'Campbell', authorAr: 'كامبل', publisher: 'Pearson', price: 110, language: 'en', pages: 850 },
  ],
  'languages': [
    { title: 'English Grammar in Use', titleAr: 'قواعد اللغة الإنجليزية', author: 'Raymond Murphy', authorAr: 'ريموند ميرفي', publisher: 'Cambridge', price: 65, language: 'en', pages: 380 },
    { title: 'Arabic for Beginners', titleAr: 'العربية للمبتدئين', author: 'Dr. Imran Hamza', authorAr: 'د. عمران حمزة', publisher: 'Al Huda', price: 48, language: 'ar', pages: 280 },
    { title: 'French Made Simple', titleAr: 'الفرنسية بسهولة', author: 'Eugene Jackson', authorAr: 'يوجين جاكسون', publisher: 'Crown', price: 42, language: 'en', pages: 320 },
  ],
  'pens': [
...
async function seed() {
  const parents = await prisma.category.findMany({ where: { parentId: null }, select: { id: true, slug: true } });
  const slugToId = {};
  parents.forEach(p => { slugToId[p.slug] = p.id; });

  let catCount = 0, prodCount = 0;
  for (const [parentSlug, l2s] of Object.entries(categoryTree)) {
    const parentId = slugToId[parentSlug];
    if (!parentId) { console.log('SKIP:', parentSlug); continue; }
    let l2Order = 0;
    for (const l2 of l2s) {
      const cl2 = await prisma.category.create({ data: { name: l2.name, nameAr: l2.nameAr, slug: l2.slug, parentId, displayOrder: l2Order++, isActive: true } });
      catCount++;
      if (l2.children) {
        let l3Order = 0;
        for (const l3 of l2.children) {
          const cl3 = await prisma.category.create({ data: { name: l3.name, nameAr: l3.nameAr, slug: l3.slug, parentId: cl2.id, displayOrder: l3Order++, isActive: true } });
          catCount++;
          const prods = products[l3.slug] || [];
          for (const p of prods) {
            await prisma.book.create({ data: {
              title: p.title, titleAr: p.titleAr || null, slug: slugify(p.title) + '-' + Math.random().toString(36).substring(2, 6),
              author: p.author || 'Unknown', authorAr: p.authorAr || null, publisher: p.publisher || null, publisherAr: p.publisherAr || null,
              description: p.description || null, descriptionAr: p.descriptionAr || null, price: p.price, stock: Math.floor(Math.random() * 50) + 5,
              language: p.language || 'en', pages: p.pages || null, brand: p.brand || null, color: p.color || null, material: p.material || null,
              ageRange: p.ageRange || null, categoryId: cl3.id, isActive: true, isFeatured: Math.random() > 0.7, isNewArrival: Math.random() > 0.7,
            }});
            prodCount++;
          }
        }
  ...
  console.log('Done! Created', catCount, 'categories and', prodCount, 'products.');
  process.exit();
}
