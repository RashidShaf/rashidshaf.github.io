    ...
    const [orders, total] = await Promise.all([
      prisma.order.findMany({
        ...
        include: {
          ...
          items: { select: { title: true, quantity: true, price: true, variantLabel: true, variantSku: true, variantColor: true, book: { select: { title: true, titleAr: true, author: true, coverImage: true } } } },
        },
      }),
