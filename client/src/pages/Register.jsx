        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="w-full max-w-md">
          ...
          <form onSubmit={handleSubmit} className="bg-surface rounded-2xl p-5 sm:p-8 border border-muted/10 shadow-sm">
            <div className="space-y-4">
              ...
              <button type="submit" disabled={loading} className="w-full py-3 bg-accent text-white font-semibold rounded-xl hover:bg-accent-light transition-colors disabled:opacity-50">
